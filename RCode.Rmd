...
```{r}
player_info <- KF.QoL::soleImport("~/Desktop/KaggleData/ITTF/ittf_player_info.csv",fread=TRUE)
```
...
A very large number of rows `r nrow(info_na)` have NA for 1+ aspect of their playing style. In fact, everything is NA!
